...
class TestVersionId(unittest.TestCase):
    """Tests for S3 version_id pinning."""
    ...
    def setUp(self):
        ...
        self.key = f"test-write-key-{uuid.uuid4().hex}"
        self.url = f"s3://{BUCKET_NAME}/{self.key}"
        self.test_ver1 = b"String version 1.0"
        self.test_ver2 = b"String version 2.0"
