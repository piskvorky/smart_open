...
Tracked under [#926](https://github.com/piskvorky/smart_open/issues/926).

## `smart_open.s3_iter_bucket` removed

Tracked in [#927](https://github.com/piskvorky/smart_open/pull/927).
...
Tracked in [#928](https://github.com/piskvorky/smart_open/pull/928).
...
Tracked in [#929](https://github.com/piskvorky/smart_open/pull/929).
...
Tracked in [#930](https://github.com/piskvorky/smart_open/pull/930).
...
Tracked in [#931](https://github.com/piskvorky/smart_open/pull/931).
...
Tracked in [#933](https://github.com/piskvorky/smart_open/pull/933).
...
Tracked in [#935](https://github.com/piskvorky/smart_open/pull/935).
...
Tracked in [#936](https://github.com/piskvorky/smart_open/pull/936).
The no-op `.terminate()` monkey-patch on the google-cloud-storage blob writer has been removed.
It had been a silent no-op for years ([Google deprecated resumable-upload termination upstream](https://cloud.google.com/storage/docs/resumable-uploads)).
...
Tracked in [#937](https://github.com/piskvorky/smart_open/pull/937).
...
These parameters had already been unsupported since v5.0.0 — see [v5.0.0](#v500) below for the actual translation recipes.

## S3 URIs no longer accept embedded `host[:port]` or the `s3u` scheme

Tracked in [#385](https://github.com/piskvorky/smart_open/issues/385).
The non-standard `s3://key:secret@host:port@bucket/key` form (and its `s3u://` http variant) is no longer parsed.
It broke [RFC 3986](https://www.rfc-editor.org/rfc/rfc3986) by stuffing two `@` separators into the authority, made S3 URI parsing the most fiddly code in the library, and was rarely used in practice.
...
Tracked in [#598](https://github.com/piskvorky/smart_open/issues/598).
...
Tracked in [#595](https://github.com/piskvorky/smart_open/issues/595).
...
```python
fin = smart_open.open(
    "/path/file.gz", compression="infer_from_extension"
)  # the default; explicit if you prefer
fin = smart_open.open("/path/file", compression=".gz")
```

# v5.0.0

Version of smart_open prior to 5.0.0 used the boto3 [resource API](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#service-resource) for communicating with S3.
...
Starting with version 5.0.0, smart_open uses the [client API](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#client) instead of the resource API.
...
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `multipart_upload_kwargs`  | [S3.Object.initiate_multipart_upload](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#S3.Object.initiate_multipart_upload) | [S3.Client.create_multipart_upload](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#S3.Client.create_multipart_upload)      |
| `object_kwargs`            | [S3.Object.get](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#S3.ObjectSummary.get)                                      | [S3.Client.get_object](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#S3.Client.get_object)                                |
| `resource_kwargs`          | S3.resource                                                                                                                                                   | [S3.client](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#client)                                                         |
| `singlepart_upload_kwargs` | [S3.Object.put](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#S3.ObjectSummary.put)                                      | [S3.Client.put_object](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#S3.Client.put_object)                                |
...
or view the help online [here](https://github.com/piskvorky/smart_open/blob/master/help.txt).
